...
DLL_EXPORT void GroupedArrayFloat32_SlicesFromEnd(GroupedArrayHandle handle,
                                                  const indptr_t *indptr_out,
                                                  float *out);
DLL_EXPORT void GroupedArrayFloat64_SlicesFromEnd(GroupedArrayHandle handle,
                                                  const indptr_t *indptr_out,
                                                  double *out);
