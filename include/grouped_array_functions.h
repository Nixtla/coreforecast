...
DLL_EXPORT int GroupedArrayFloat32_TakeFromEnd(GroupedArrayHandle handle, int k,
                                               float *out);
DLL_EXPORT int GroupedArrayFloat64_TakeFromEnd(GroupedArrayHandle handle, int k,
                                               double *out);
