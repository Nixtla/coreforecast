...
`min_samples` | <code>int</code> | The minimum number of samples required to compute the statistic.
If None, it is set to `window_size`. | *required*
...
`min_samples` | <code>[int](#int)</code> | The minimum number of samples required to compute the statistic.
If None, it is set to `window_size`. | <code>None</code>
